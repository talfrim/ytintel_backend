...
def get_all_toplevel_comments_for_channel(channel_id, page_token="", max_results="100"):
    ...
    if int(res.status_code) == 200:
        ...
        comment_list = [comm for comm in comment_list if comm is None]  # removing all none values (for comments who are on the channel and not on video)
        return comment_list
...
lst = get_all_toplevel_comments_for_channel("UC_x5XG1OV2P6uZZ5FSM9Ttw")
print(lst)
